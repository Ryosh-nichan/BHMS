...
<body id="page-top">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Add Boarder</h4>
    ...
    <div class="modal fade" role="dialog" tabindex="-1" id="remove">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Remove</h4><button class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#remove" data-id="<?= $row['id'] ?>">Remove</button>
                </div>
                <div class="modal-body">
    ...
    <script>
        ...
        var modal = $(this);
        modal.find('input[name="id"]').val(id); // Set the value in the hidden input
    });
    </script>
</body>
