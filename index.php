...
<body>
    <div id="wrapper">
        <div class="d-flex flex-column" id="content-wrapper" style="background: rgb(255,255,255);">
            <nav class="navbar navbar-expand-lg shadow py-3 border mb-2 navbar-light">
            ...
            <section class="position-relative py-2 py-xl-5">
                <div class="container">
                    <div class="row mb-2">
                        <div class="col-md-5 col-xl-6 text-center mx-auto">
                            <h2>Log in</h2>
                        </div>
                    </div>
                                ...
                                <div class="card-body d-flex flex-column align-items-center">
                                    <div class="bs-icon-xl bs-icon-circle bs-icon-primary bs-icon my-4"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="currentColor" viewBox="0 0 16 16" class="bi bi-person-fill-lock">
                                        ...
                                        <form action="functions/login.php" method="post">
                                            ...
                                            <p class="text-muted text-center">Boarding House Management Systems</p>
                                        </form>
                                </div>
                            </div>
                        </div>
...
<!-- Show modal if error message is set -->
